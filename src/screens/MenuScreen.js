...
const styles = StyleSheet.create({ screen: { backgroundColor: '#F7F4EE', flex: 1, padding: 24 }, eyebrow: { color: '#1677FF', fontSize: 12, fontWeight: '800', letterSpacing: 1.5, marginTop: 18 }, title: { color: '#203B35', fontSize: 28, fontWeight: '800', marginBottom: 24, marginTop: 10 }, item: { alignItems: 'center', backgroundColor: '#FFFFFF', borderColor: '#D7E5FF', borderRadius: 8, borderWidth: 1, flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10, minHeight: 58, paddingHorizontal: 18 }, itemText: { color: '#203B35', fontSize: 15, fontWeight: '700' }, arrow: { color: '#1677FF', fontSize: 28, lineHeight: 28 } });
