...
import { openDocumentPdf, shareDocumentPdf } from '../utils/pdf';
...
export default function DocumentDetailScreen({ route, navigation }) {
  ...
  async function generatePdf() {
    try { await openDocumentPdf(document); } catch { Alert.alert('Aperçu indisponible', 'Installez une application PDF ou utilisez le bouton Partager.'); }
  }
