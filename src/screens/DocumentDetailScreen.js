...
const styles = StyleSheet.create({ screen: { flex: 1, backgroundColor: '#F7F4EE' }, content: { padding: 20 }, number: { color: '#203B35', fontSize: 28, fontWeight: '800' }, client: { color: '#202522', fontSize: 18, fontWeight: '700', marginTop: 8 }, meta: { color: '#7B847D', marginBottom: 24, marginTop: 5, textTransform: 'capitalize' }, line: { backgroundColor: '#FFFFFF', borderBottomColor: '#ECE7DE', borderBottomWidth: 1, padding: 14 }, description: { color: '#203B35', fontSize: 15, fontWeight: '800' }, detail: { color: '#7B847D', marginTop: 4 }, total: { color: '#203B35', fontSize: 22, fontWeight: '800', marginVertical: 22, textAlign: 'right' }, secondaryButton: { alignItems: 'center', borderColor: '#1677FF', borderRadius: 7, borderWidth: 1, minHeight: 48, justifyContent: 'center', marginBottom: 10 }, secondaryText: { color: '#1677FF', fontWeight: '800' }, button: { alignItems: 'center', backgroundColor: '#1677FF', borderRadius: 7, minHeight: 50, justifyContent: 'center' }, buttonText: { color: '#FFFFFF', fontWeight: '800' }, empty: { alignItems: 'center', backgroundColor: '#F7F4EE', flex: 1, justifyContent: 'center' } });
