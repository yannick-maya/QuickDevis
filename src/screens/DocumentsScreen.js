...
const styles = StyleSheet.create({ screen: { flex: 1, backgroundColor: '#F7F4EE' }, content: { padding: 20, paddingBottom: 40 }, heading: { color: '#203B35', fontSize: 22, fontWeight: '800', marginBottom: 14, marginTop: 8 }, label: { color: '#68716B', fontSize: 12, fontWeight: '800', marginBottom: 8, marginTop: 8, textTransform: 'uppercase' }, segment: { flexDirection: 'row', gap: 6, marginBottom: 12 }, segmentButton: { borderColor: '#D9D4CB', borderRadius: 7, borderWidth: 1, flex: 1, minHeight: 42, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 8 }, selected: { backgroundColor: '#203B35', borderColor: '#203B35' }, segmentText: { color: '#203B35', fontSize: 12, fontWeight: '700', textAlign: 'center' }, choice: { backgroundColor: '#FFFFFF', borderColor: '#D9D4CB', borderRadius: 7, borderWidth: 1, marginRight: 8, padding: 11 }, choiceSelected: { backgroundColor: '#DCE8DF', borderColor: '#203B35' }, choiceText: { color: '#203B35', fontWeight: '700' }, choices: { marginBottom: 8 }, input: { backgroundColor: '#FFFFFF', borderColor: '#D9D4CB', borderRadius: 7, borderWidth: 1, color: '#202522', fontSize: 15, marginBottom: 10, minHeight: 48, paddingHorizontal: 14 }, inline: { flexDirection: 'row', gap: 10 }, half: { flex: 1 }, secondaryButton: { alignItems: 'center', borderColor: '#B45A3C', borderRadius: 7, borderWidth: 1, minHeight: 46, justifyContent: 'center' }, secondaryText: { color: '#B45A3C', fontWeight: '800' }, line: { backgroundColor: '#FFFFFF', borderBottomColor: '#ECE7DE', borderBottomWidth: 1, padding: 13 }, lineName: { color: '#203B35', fontSize: 15, fontWeight: '800' }, lineDetail: { color: '#7B847D', marginTop: 4 }, total: { color: '#203B35', fontSize: 20, fontWeight: '800', marginVertical: 18, textAlign: 'right' }, button: { alignItems: 'center', backgroundColor: '#B45A3C', borderRadius: 7, minHeight: 50, justifyContent: 'center', marginBottom: 24 }, buttonText: { color: '#FFFFFF', fontWeight: '800' }, empty: { color: '#7B847D', paddingVertical: 12, textAlign: 'center' } });
