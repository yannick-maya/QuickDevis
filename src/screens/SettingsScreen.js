...
const styles = StyleSheet.create({ screen: { backgroundColor: '#F7F4EE', flex: 1 }, content: { padding: 20 }, heading: { color: '#1459C7', fontSize: 22, fontWeight: '800', marginBottom: 14, marginTop: 10 }, input: { backgroundColor: '#FFFFFF', borderColor: '#BFD3F7', borderRadius: 7, borderWidth: 1, color: '#202522', fontSize: 15, marginBottom: 10, minHeight: 48, paddingHorizontal: 14 }, button: { alignItems: 'center', backgroundColor: '#1677FF', borderRadius: 7, justifyContent: 'center', minHeight: 50 }, buttonText: { color: '#FFFFFF', fontWeight: '800' }, description: { color: '#68716B', lineHeight: 22, marginBottom: 14 }, secondaryButton: { alignItems: 'center', borderColor: '#1677FF', borderRadius: 7, borderWidth: 1, justifyContent: 'center', minHeight: 50 }, secondaryText: { color: '#1677FF', fontWeight: '800' } });
